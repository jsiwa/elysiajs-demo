...
const app = new Elysia()
  ...
  .get('/demo-i18n-routes', () => Bun.file('demo-i18n-routes.html').text())
  .get('/demo-link-generator', () => Bun.file('demo-link-generator.html').text())
  .get('/demo-path-utils', () => Bun.file('demo-path-utils.html').text())
  .listen(3000)
...
console.log('  - /demo-i18n-routes (I18n Routes Demo)')
console.log('  - /demo-link-generator (Link Generator Demo)')
console.log('  - /demo-path-utils (Path Utils Demo)')
console.log('')
...
console.log('  - Routes: http://localhost:3000/demo-i18n-routes')
console.log('  - Links: http://localhost:3000/demo-link-generator')
console.log('  - Paths: http://localhost:3000/demo-path-utils')
